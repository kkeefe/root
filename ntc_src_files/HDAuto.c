	...
	for (ULong64_t j = 0; j < nentries; j++)
	{
		...
		if (limit <= 10)
		{
			...
			else
			{
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile11 << (motorPositionAnt / 400) - 100 << " " << mean_DeltaT1 << " "
								 << "0"
								 << " " << mean_DeltaT1Error << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile2 << (motorPositionAnt / 400) - 100 << " " << sigma_DeltaT1 << " "
								<< "0"
								<< " " << sigma_DeltaT1Error << endl;
				}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile3 << (motorPositionAnt / 400) - 100 << " " << meanTimePos << " "
								<< "0"
								<< " " << sigmaTimePos << endl;
				}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile7 << (motorPositionAnt / 400) - 100 << " " << meanAmplPos << " "
								<< "0"
								<< " " << sigmaAmplPos << endl;
				}
				//if ((motorPositionAnt>19000)&&(motorPositionAnt<61000)){outputFile4<<(motorPositionAnt/4000)-10<<" "<<sigma_DeltaT1<<" "<<"0"<<" "<<sigma_DeltaT1Error<<endl;}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile13 << (motorPositionAnt / 400) - 100 << " " << mean_LogAmpl << " "
								 << "0"
								 << " " << mean_LogAmplError << endl;
				}
				//outputFile4<<(motorPositionAnt/4000)-10<<" "<<sigma_LogAmpl<<" "<<"0"<<" "<<sigma_LogAmplError<<endl;
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile12 << (motorPositionAnt / 400) - 100 << " " << sigma_LogAmpl << " "
								 << "0"
								 << " " << sigma_LogAmplError << endl;
				}
				...
				outputFile5 << (motorPositionAnt / 4000) - 10 << " " << mean_LogAmplSlow << " "
							<< "0"
							<< " " << mean_LogAmplSlowError << endl;
				outputFile6 << (motorPositionAnt / 4000) - 10 << " " << sigma_LogAmplSlow << " "
							<< "0"
							<< " " << sigma_LogAmplSlowError << endl;
				//*******************************************
				//***********hRatio************************
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile14 << (motorPositionAnt / 4000) - 10 << " " << mean_hRatio << " "
								 << "0"
								 << " " << mean_hRatioError << endl;
				}
				//outputFile25<<(motorPositionAnt/4000)-10<<" "<<sigma_hRatio<<" "<<"0"<<" "<<sigma_hRatioError<<endl;
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile26 << (motorPositionAnt / 4000) - 10 << " " << sigma_hRatio << " "
								 << "0"
								 << " " << sigma_hRatioError << endl;
				}
				//
				//
				//*******************************************
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile8 << (motorPositionAnt / 4000) - 10 << " " << mean << " "
								<< "0"
								<< " " << meanError << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile9 << (motorPositionAnt / 4000) - 10 << " " << rms << " "
								<< "0"
								<< " " << rmsError << endl;
				}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile10 << (motorPositionAnt / 4000) - 10 << " " << meanS << " "
								 << "0"
								 << " " << meanErrorS << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile24 << (motorPositionAnt / 4000) - 10 << " " << rmsS << " "
								 << "0"
								 << " " << rmsErrorS << endl;
				}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile17 << (motorPositionAnt / 4000) - 10 << " " << mean_hdiffAmplVar1 << " "
								 << "0"
								 << " " << mean_hdiffAmplVar1Error << endl;
				}
				//outputFile18<<(motorPositionAnt/4000)-10<<" "<<sigma_hdiffAmplVar1<<" "<<"0"<<" "<<sigma_hdiffAmplVar1Error<<endl;
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile19 << (motorPositionAnt / 4000) - 10 << " " << sigma_hdiffAmplVar1 << " "
								 << "0"
								 << " " << sigma_hdiffAmplVar1Error << endl;
				}
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile20 << (motorPositionAnt / 4000) - 10 << " " << meanMax0 << " "
								 << "0"
								 << " " << meanErrorMax0 << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile21 << (motorPositionAnt / 4000) - 10 << " " << meanMax1 << " "
								 << "0"
								 << " " << meanErrorMax1 << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile22 << (motorPositionAnt / 4000) - 10 << " " << rmsMax0 << " "
								 << "0"
								 << " " << rmsErrorMax0 << endl;
				}
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile23 << (motorPositionAnt / 4000) - 10 << " " << rmsMax1 << " "
								 << "0"
								 << " " << rmsErrorMax1 << endl;
				}
				//*******************************************
	...
	for (ULong64_t j = 0; j < nentries; j++)
	{
		...
		if (limit <= 10.5)
		{
			...
			else
			{
				...
				if ((motorPositionAnt > 19000) && (motorPositionAnt < 61000))
				{
					outputFile16 << (motorPositionAnt / 400) - 100 << " " << meanPos << " "
								 << "0"
								 << " " << sigmaPos << endl;
				}
				//if ((motorPositionAnt>19000)&&(motorPositionAnt<61000)){outputFile4<<(motorPositionAnt/4000)-10<<" "<<sigma_DeltaT1<<" "<<"0"<<" "<<sigma_DeltaT1Error<<endl;}
		...
		} //closes with if(limit)
	}	 //closes with ulong, nentries
	outputFile15.close();
} //closes hdauto
